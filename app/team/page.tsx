...
const teamMembers = [
  ...
  {
    name: "Olivia Pozza",
    role: "Vice President", // Updated role
    bio: "Hi everyone! I'm Olivia, and I'm thrilled to serve as Vice President of the Women in Entrepreneurship student organization at UW–Madison. I co-founded WE to empower ambitious and creative women to connect, collaborate, and grow in whatever step they may be in their entrepreneurial journeys. I'm studying Consumer Behavior & Marketplace Studies, Entrepreneurship, and Business, and I'm passionate about turning bold ideas into real impact. Co-founding this club with Trinity has been one of the most rewarding parts of college, and I'm excited to help others build confidence and access the tools they need to launch ventures. Whether it's through hosting events, creating content, or providing mentorship, I'm eager to help WE thrive on campus. Outside of WE, you'll find me grabbing a matcha latte on State Street, hitting the gym, exploring new study spots, FaceTiming my family (mostly asking to see the dog), shopping, and spending time with friends. Can't wait to connect with you all!",
    image:
